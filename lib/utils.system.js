  ...
  return {
    execute: (function () {
      ...
      exports({
        cached: cached,
        call: call,
        equalToFalse: equalToFalse,
        equalToTrue: equalToTrue,
        getSymbolVal: getSymbolVal,
        hasOwn: hasOwn,
        hasProp: hasProp,
        isArray: isArray,
        isBoolean: isBoolean,
        ...
        isTure: isTure,
        isUndef: isUndef,
        isUndefAndNull: isUndefAndNull,
        lazyFun: lazyFun,
        makeMap: makeMap,
        mergeArray: mergeArray,
        polyfillBind: polyfillBind,
        remove: remove,
       ...
       * 转换为骆驼命名法
       */
      const camelize = exports('camelize', lazyFun(selectCached, (str) => {
          /**
           * 找到以横线开头的ring|symbol
           * 括号里进行分组
           * 括号里的是第一组
       ...
       * 首字母大写
       */
      const capitalize = exports('capitalize', lazyFun(selectCached, (str) => {
          return str.charAt(0).toUpperCase() + str.slice(1);
      }));
      /**
       * 驼峰命名转横线命名法
       */
      const hypnenate = exports('hypnenate', lazyFun(selectCached, (str, isCached = true) => {
          /**
           * 大写字母
           */
