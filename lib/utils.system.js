    ...
    execute: function () {
      ...
      function isPromise(v) {
        return (
          ...
          (v.then === 'function' && v.catch === 'function')
        )
      }
       ...
       * 转换为骆驼命名法
       */
      const camelize = exports(
        'camelize',
        lazyFun(selectCached, (str) => {
          /**
           * 找到以横线开头的ring|symbol
           * 括号里进行分组
           * 括号里的是第一组
       ...
       * 驼峰命名转横线命名法
       */
      const hypnenate = exports(
        'hypnenate',
        lazyFun(selectCached, (str, isCached = true) => {
          /**
           * 大写字母
           */
